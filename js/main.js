document.addEventListener('DOMContentLoaded', () => {
  ...
  const PROJECTS = {
    ...
    pumpumkin: {
      ...
      flow: '호박 클릭 → 사탕 획득 → 업그레이드 구매 → 호박 진화 → 반복 (25단계)',
      tags: ['Unity 6000', 'C#', 'DI Container', 'EventBus', 'Excel ↔ SO', 'Object Pooling', 'WebGL', 'URP'],
      features: [
        '25단계 / 5등급 호박 진화 — Normal → Rare → Epic → Legendary → Mythic',
        '4종 업그레이드 — 클릭강화 / 자동수집 / 크리티컬 / 광폭모드',
        '랜덤 이벤트 — 황금 호박 (10배 보너스) + 귀신 스폰 탭 이벤트',
        '6종 사탕 진화 (107개 스프라이트) — 클릭강화 레벨에 따른 외형 변화',
        '지수적 비용 증가 곡선 밸런싱'
      ],
